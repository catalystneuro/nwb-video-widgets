...
* Optimized init-time metadata loading to use indexed timestamp access instead of loading full arrays, improving widget creation speed for DANDI streaming with large datasets [PR #XX](https://github.com/catalystneuro/nwb-video-widgets/pull/XX)
